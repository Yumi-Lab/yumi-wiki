# 1.7 OpenBurn Laser Setup and First Engraving
...
## 1.7.3 - Create a Machine Profile for Your Model
...
## 1.7.4 - Import or Create a Design
...
## 1.7.7 - Frame the Engraving Area
