...
## 4. FDA Food-Contact Compliance

FDA compliance (US 21 CFR) certifies that a specific filament grade is safe for food-contact applications — kitchen tools, containers, utensils. **This only applies to the grades listed below**, not to the YUMI range as a whole: check the exact material before printing anything that will touch food.

| Document | Scope | Size | Download |
|---|---|---|---|
| YUMI High Speed PETG — FDA Compliance (2023) | YUMI High Speed PETG | 299 KB | [![Download FDA](/img/Filament/badge-fda.svg)](pdf/YUMI_Filament_High_Speed_PETG_FDA_2023.pdf){ target=_blank } |
| YUMI — FDA Compliance Report (TÜV, 2021) | General FDA report | 589 KB | [![Download FDA](/img/Filament/badge-fda.svg)](pdf/YUMI_Filament_FDA_2021_TUV.pdf){ target=_blank } |

---

## 5. CE Declaration & RoHS Compliance

The **CE** mark is the manufacturer's declaration that a product meets EU health, safety and environmental requirements — mandatory to sell in the EU. **RoHS** (EU 2011/65) restricts hazardous substances (lead, cadmium, certain phthalates, etc.); these reports test each filament color individually, since pigments are a common source of restricted substances.

| Document | Scope | Size | Download |
|---|---|---|---|
| YUMI — CE Certificate (TÜV, 2021) | Full YUMI filament range | 508 KB | [![Download CE](/img/Filament/badge-ce.svg)](pdf/YUMI_Filament_CE_Certificate_2021_TUV.pdf){ target=_blank } |
| YUMI PLA Transparent — RoHS Test Report | YUMI PLA, transparent | 3.9 MB | [![Download RoHS](/img/Filament/badge-rohs.svg)](pdf/YUMI_Filament_PLA_Transparent_RoHS.pdf){ target=_blank } |
| YUMI PLA Black — RoHS Test Report | YUMI PLA, black | 2.1 MB | [![Download RoHS](/img/Filament/badge-rohs.svg)](pdf/YUMI_Filament_PLA_Black_RoHS.pdf){ target=_blank } |
| YUMI Filament White — RoHS Test Report | YUMI filament, white | 2.1 MB | [![Download RoHS](/img/Filament/badge-rohs.svg)](pdf/YUMI_Filament_White_RoHS.pdf){ target=_blank } |

---

## 6. Independent Test Reports

Beyond regulatory paperwork, these are independent lab reports that validate real-world performance for specific product lines — mechanical strength, hardness, antibacterial action — useful when specifying a material for a demanding application.

| Document | Scope | Size | Download |
|---|---|---|---|
| YUMI FPLA+ (Flexible PLA) — Shore A Hardness Report | YUMI FPLA+ flexible filament | 999 KB | [![Download Report](/img/Filament/badge-report.svg)](pdf/YUMI_Filament_FPLA_Plus_Shore_A_Hardness_Report.pdf){ target=_blank } |
| YUMI FPLA+ (Flexible PLA) — Mechanical Test Report | YUMI FPLA+ flexible filament | 1.1 MB | [![Download Report](/img/Filament/badge-report.svg)](pdf/YUMI_Filament_FPLA_Plus_Test_Report.pdf){ target=_blank } |
| YUMI Nylon 25GF — Test Report (2021) | YUMI Nylon 25GF (glass-fiber reinforced) | 16.6 MB | [![Download Report](/img/Filament/badge-report.svg)](pdf/YUMI_Filament_Nylon_25GF_Test_Report_2021.pdf){ target=_blank } |
| YUMI PLA — Antibacterial Test Report | YUMI PLA | 2.6 MB | [![Download Report](/img/Filament/badge-report.svg)](pdf/YUMI_Filament_PLA_Antibacterial_Report.pdf){ target=_blank } |
| YUMI PLA HYPER — Mechanical Test Report (2023, Wuxi lab) | YUMI PLA HYPER | 2.8 MB | [![Download Report](/img/Filament/badge-report.svg)](pdf/YUMI_Filament_PLA_HYPER_Mechanical_Test_Report_2023.pdf){ target=_blank } |

---

Need a certificate that is not listed here, or one covering a specific batch/lot number? Contact YUMI-LAB support with the reference of your order.
