...
- [Smart Pi One](https://wanhao-europe.com/collections/yumi-smart-pi-nano-computer-diy/products/yumi-smart-pi-one-1g-ddr3-processeur-h3-allwinner){ target=_blank }
...
[Download](https://etcher.balena.io/){ target=_blank }, install, and launch Etcher.
...
## 4. Booting from MicroSD (First Boot)
