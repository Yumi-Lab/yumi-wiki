...
|---|---|---|---|---|
| ![](/img/SmartPi/OS/debian-logo.svg){ .off-glb width="18" } **[Debian 13 Trixie](../SmartPi_Linux.md)** | Armbian | Server + Desktop | ~528 MB (server) | New installations — current stable |
| ![](/img/SmartPi/OS/debian-logo.svg){ .off-glb width="18" } **[Debian 12 Bookworm](../SmartPi_Linux.md)** | Armbian | Server + Desktop | ~528 MB (server) | Proven stability, wide package coverage |
| ![](/img/SmartPi/OS/ubuntu-logo.svg){ .off-glb width="18" } **[Ubuntu 24.04 Noble](../SmartPi_Linux.md)** | Armbian | Server + Desktop | ~528 MB (server) | Ubuntu users, abundant documentation |
| ![](/img/SmartPi/OS/ubuntu-logo.svg){ .off-glb width="18" } **[Ubuntu 22.04 Jammy](../SmartPi_Linux.md)** | Armbian | Server (+ Desktop up to v1.7.0) | ~528 MB (server) | Existing 22.04 deployments |
| ![](/img/SmartPi/OS/debian-logo.svg){ .off-glb width="18" } **[Debian 11 Bullseye](../SmartPi_Linux.md)** | Armbian | Server | ~528 MB | Legacy setups only — end of life |
...
- **[DietPi](SmartPi_DietPi.md)** — when RAM is what you are short of. About 87 MB at idle instead of 528 MB, with a menu-driven software catalog. Headless only, and currently a release candidate.
